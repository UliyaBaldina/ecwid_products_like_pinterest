...
function jsiBoxInit()
{
	...
	var boxHTML =  '<style type="text/css">#jsiMainBox * {margin: 0; padding: 0; text-decoration: none;} #jsiMainBox a.jsiBtn {outline: none; float:right; color: #fff; font-size: 30px; width: 40px;  vertical-align:middle;font-weight:normal; } </style>'
                  +'<div id="wrapJsiBox" style="-webkit-border-radius: 7px;-moz-border-radius: 7px;border-radius: 7px;position: absolute; top:0; left:0; display: none; z-index: 1000; background-color:'+jsiBox.overlayColor+'; opacity: 0.6; filter: alpha(opacity=\'60\');"></div>'
                  +'<div style="position: absolute; top: 0; left: 0; width: 100%; z-index: 2000;">'
                  +'  <div id="jsiMainBox" style="-webkit-border-radius: 7px;-moz-border-radius: 7px;border-radius: 7px;color: #fff;text-align:left;position: relative; display: none; margin: auto; z-index: 2; width: 400px; background:'+jsiBox.boxBgColor+'; border: '+jsiBox.boxBorderWidth+' solid '+jsiBox.boxBorderColor+'; padding-bottom: 4px;">'
                  +'      <a href="#" style="border:0;outline:none;padding:0 -25px 0 0;width:28px;line-height:32px;margin-right:-25px;margin-top:-13px" onclick="return jsiBoxClose();" class="jsiBtn"><img style="border:0;outline:none;" src="images/close.png"/></a>'
                  +'	  <p style="text-align: right; font: bold 10px Tahoma; padding-top: 10;width:100%;overflow:hidden;padding-bottom:0;">'
                  +'        <img src="'+jsiBox.selfDir+'img/ajax-loader2.gif" alt="" id="jsiBoxLoading" style="float:left; display:inline; margin:7px 5px 0 8px;" />'     
                  +'        <span style="width: 75px; float: right; height: 37px;position:relative;display: none;">'
                  +'          <a href="#" id="nextJsiBoxLink" onclick="return jsiBoxNext();" style="display: none;position:absolute;top: 0;right: 0;line-height:30px;" class="jsiBtn">'+jsiBox.nextArrow+'</a>'
                  +'          <a href="#" id="prevJsiBoxLink" onclick="return jsiBoxPrev();" style="display: none;position:absolute;top: 0;left: 0;line-height:30px;" class="jsiBtn">'+jsiBox.prevArrow+'</a>'                 
                  +'        </span>'
                  +'      </p>'
                  ...
                  +'      </div>'
                  +'      <span id="jsiBoxTitle" style="margin:0 8px; font: normal 14px Tahoma;color:#000;text-align:center;"></span>'
                  +'  </div>'
                  +'</div>';
